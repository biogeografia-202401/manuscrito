Asignación de manuscrito 1. Diseño de muestreo y colecta de datos de
campo
================
...
> Plazo de entrega extendido: 26 de marzo, 16 horas.
...
> conjunta en el aula y en tutorías.

# Asignación de manuscrito 1. Diseño de muestreo y colecta de datos de campo

En teoría, el primer elemento de **una buena investigación comienza con
unas buenas preguntas** o, si prefieres, con unos buenos objetivos, o
con ambos. Se supone que las preguntas son las que guían el resto del
proceso de investigación desde el comienzo, por lo que formular
preguntas y definir objetivos debería ser el primer paso (un “truquito”:
en ecología numérica, uno de los mejores lugares para formularse
preguntas es, el campo).

El segundo elemento de una buena investigación, consiste en contar con
un buen diseño de muestreo y una colecta de datos de campo realizada de
forma sistemática. En mi opinión, considero esta parte la más importante
de un trabajo de ecología numérica (incluso por encima de las
preguntas), pues si colectamos buenos datos hoy, en el futuro podremos
responder múltiples preguntas, incluso algunas que no hayamos formulado
inicialmente.
...
procesamiento y analíticas”. Por tal razón, esta asignación tiene dos
objetivos:

1.  Redactar la primera subsección de la metodología de tu manuscrito, a
    la que podrías titular “Diseño de muestreo y colecta de datos de
    campo”.

2.  Colectar tus muestras.

Por lo tanto, serán dos los entregables de esta práctica:

-   Tus muestras de hormigas, colectadas y registradas en plataforma en
    línea (ver detalles más abajo). Todavía **no** identificarás
    hormigas, sólo las colectaras y registrarás. Harás el trabajo de
    campo, y deberás demostrar que colectaste tus hormigas.
...
basado en el trabajo Batlle (2023), dentro del cual se encuentra el
documento [“Clasificación de hexágonos del polígono núcleo del campus de
la Universidad Autónoma de Santo Domingo (UASD) en su sede central,
usando coberturas del
suelo”](https://github.com/geofis/coberturas-suelo-uasd/blob/main/clasificacion-de-hexagonos.md).
Dicho documento explica el procedimiento de generación de los hexágonos
y su clasificación.
...
-   Elige un día para realizar las colectas (un día completo será
    suficiente; prefiere los domingos, pues hay menos gente en el
    campus). Comienza lo más temprano que puedas.

-   El día elegido, realiza las colectas siguiendo estos pasos:

    -   Llega al primer hexágono asignado usando el [mapa
    ...
    -   Abre ODK Collect o GIC Collect y llena un formulario nuevo de
        ODK “Biogeografia-202401”. Completa los datos que te pide en la
        ...
        Este formulario lo usarás hasta que termines de colectar en el
        hexágono; por esta razón, lo dejarás abierto, y sólo lo cerrarás
        cuando hayas terminado de colectar en el hexágono.

    -   Colecta tantas hormigas como puedas; intenta colectar en suelo,
        en corteza de troncos, paredes e infraestructuras. Para ello,
        abre el frasco, humedece el pincel en alcohol (mantén el frasco
    ...
    -   Cuando haya pasado el tiempo, podrás cerrar el formulario. Para
        ...
        finalizado y enviarlo si lo deseas. También puedes desmarcar la
    ...
    -   Inserta una etiqueta en el frasco (lápiz y papel vegetal). Lo
        ...
        (e.g. 18.23424$^\circ$, -71.82321$^\circ$).
...
``` r
secuencial <- paste0(c(paste0(0, paste0(1:9)), 10:25))
estudiantes <- data.frame(id_estudiante = paste0('estudiante-', secuencial))
...
```
    ...
    ##   `/home/jr/Documentos/clases_UASD/202401/geo131/repos-gh/manuscrito/data/h3-res-12-no-edificios-3-grupos.gpkg' 
    ##   using driver `GPKG'
...
<td style="text-align:left;">
H0516, H0677, H0682, H0717, H0796, H0811, H0926, H0994, H1043, H1131,
H1154, H1156, H1219, H1408, H1475
</td>
</tr>
<tr>
<td style="text-align:left;">
...
<td style="text-align:left;">
H